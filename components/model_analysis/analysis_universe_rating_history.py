...
class score_eval:
    ...
    def __plot_dist_score(self, df, filename):
        ...
        fig = plt.figure(figsize=(num_cur * 4, num_score * 4), dpi=120, constrained_layout=True)  # create figure for tests & train boxplot
        k=1
...
if __name__ == "__main__":
    ...
    eval.test_current()     # tests on universe_rating + test_fundamentals_score_details_{currency}
