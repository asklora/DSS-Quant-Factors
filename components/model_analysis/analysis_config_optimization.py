...
if __name__ == "__main__":
    ...
    df_na = df.loc[(df['_train_currency'].isin(['HKD', 'CNY'])) & (df['_name_sql'] == 'w4_d-7_20220324031027_debug')]
    ...
    df_ws = df.loc[((df['_train_currency'] == 'EUR') & (df['_name_sql'] == 'w4_d-7_20220321173435_debug')) |
                   ((df['_train_currency'] == 'USD') & (df['_name_sql'] == 'w4_d-7_20220312222718_debug')),
