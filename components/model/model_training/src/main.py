...
if __name__ == "__main__":
    ...
    if not args.pass_train:
        ...
        with mp.Pool(processes=args.processes) as pool:
            ...
            all_train_currencys_df = load_train_configs(data_configs, load_configs, period_list, args.restart)
            all_train_currencys = all_train_currencys_df.to_dict("records")
            all_train_currencys = [tuple([data, sql_result, e]) for e in all_train_currencys]

            pool.starmap(mp_rf, all_train_currencys)
