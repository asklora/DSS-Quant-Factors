...
space_lgbm_class['industry'] = {
    ...
    # 'min_gain_to_split': 0,
    'lambda_l1': hp.quniform('lambda_l1', 0, 20, 10),
...
space_lgbm_class['currency'] = {
    ...
    'boosting_type': 'gbdt',
    'max_bin': hp.choice('max_bin', [128, 256]),
    'num_leaves': hp.quniform('num_leaves', 200, 300, 50),
    'min_data_in_leaf': hp.quniform('min_data_in_leaf', 10, 50, 20),
    'feature_fraction': hp.quniform('feature_fraction', 0.4, 0.8, 0.2),
    'bagging_fraction': hp.quniform('bagging_fraction', 0.4, 0.8, 0.2),
    'bagging_freq': hp.choice('bagging_freq', [4, 8]),
    # 'min_gain_to_split': 0,
    'lambda_l1': hp.quniform('lambda_l1', 0, 30, 15),
    'lambda_l2': hp.quniform('lambda_l2', 0, 30, 15),
}
