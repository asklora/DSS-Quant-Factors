...
space_lgbm_reg = {
    ...
    'num_leaves': hp.choice('num_leaves', [20, 100, 200]),
    'min_data_in_leaf': hp.choice('min_data_in_leaf', [2, 5, 20]),
    'feature_fraction': hp.choice('feature_fraction', [0.4, 0.8]),
    'bagging_fraction': hp.choice('bagging_fraction', [0.4, 0.8]),
